  ...
  return (
    <section className="mk-section" id="features">
      <div className="mk-container">
        <h2 className="mk-h2">Everything you need for shared shopping</h2>
        <p className="mk-section-sub">
          The list stays in sync for everyone, so whoever is in the store
          always sees what is left to buy.
        </p>
